<template>
  <div>
    ...
    <div :class="isSideMenu ? 'w-[calc(100%-45%)]' : 'w-[calc(100%-65px)]'" class="bg-black flex duration-300 py-40 justify-center items-center flex-wrap gap-6">
      ...
      <button @click="isFinishTest ? finishTestExit() : finishTest()" class="py-3 px-6 rounded bg-[#3cafb3] text-xl text-white">
        {{ isFinishTest ? "Qayta topshirish" : "Testni yakunlash" }}
      </button>
    </div>

    <QuizzSider :quizzes="quizzes" v-model="isSideMenu" @finish:test="finishTestExit" />
  </div>
</template>
...
const quizzes = reactive([
  { id: 1, question: "2+2 = ?", answers: ["4", "2", "3", "5"], correctAnswer: "4" },
  { id: 2, question: "2+12 = ?", answers: ["14", "2", "3", "5"], correctAnswer: "14" },
  { id: 3, question: "2+6 = ?", answers: ["8", "2", "3", "5"], correctAnswer: "8" },
  { id: 4, question: "5+2 = ?", answers: ["4", "2", "3", "7"], correctAnswer: "7" },
  { id: 5, question: "1+2 = ?", answers: ["4", "2", "3", "5"], correctAnswer: "3" },
  { id: 6, question: "6+2 = ?", answers: ["4", "2", "8", "5"], correctAnswer: "8" },
  { id: 7, question: "2+10 = ?", answers: ["4", "2", "12", "5"], correctAnswer: "12" },
  { id: 8, question: "3+3 = ?", answers: ["4", "6", "3", "5"], correctAnswer: "6" },
  { id: 9, question: "5+2 = ?", answers: ["4", "2", "7", "5"], correctAnswer: "7" },
  { id: 10, question: "4+1 = ?", answers: ["4", "2", "3", "5"], correctAnswer: "5" },
]);
...
const finishTest = () => {
  ...
  trueQuizzes.value = quizzes.reduce((acc, item) => acc + (item.correctAnswer === item.userAnswer ? 1 : 0), 0);
